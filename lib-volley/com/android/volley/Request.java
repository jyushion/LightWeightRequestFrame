...
public abstract class Request<T> implements Comparable<Request<T>> {
	...
	public static class FormHeader {
		...
		public FormHeader(String key, String value) {
			super();
			this.key = key;
			this.value = value;
		}
		...
		public String toFromParam() {
			StringBuilder buffer = new StringBuilder();
			buffer.append("--");
			buffer.append(BOUNDARY);
			buffer.append("\r\n");
			buffer.append("Content-Disposition: form-data; name=\"" + getKey() + "\"\r\n\r\n");
...
//		private String contentType = "application/octet-stream";
		...
		public FormFile setData(byte[] data) {
			this.data = data;
			return this;
		}
		...
		public FormFile setFormName(String formName) {
			this.formName = formName;
			return this;
		}
...
//			buffer.append("Content-Type: image/png\r\n\r\n");
		...
		public long getFromFileLength() {
			int dispositionLen = getFileDisposition().getBytes().length;
			long fileLen = 0;
			if (data != null) {
				fileLen = data.length;
			} else {
			...
			int endLineLen = getEndLine().getBytes().length;
			return dispositionLen + fileLen + endLineLen;
		}
