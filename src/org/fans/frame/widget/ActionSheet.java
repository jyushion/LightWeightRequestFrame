...
public class ActionSheet extends Dialog {
	...
	protected ActionSheet(Context context, boolean isMenuMode) {
		...
		mRootView = mInflater.inflate(R.layout.action_sheet_base, null);
	 ...
	 */
	@Deprecated
	public void setHeaderView(View view, LinearLayout.LayoutParams params) {
		if (view != null) {
			if (params == null) {
	 ...
	 * @param params
	 */
	public void setActionContentView(View view, LinearLayout.LayoutParams params) {
		if (view != null) {
	...
	public Drawable getSelectorByType(int selectorType) {
		...
		case SELECTOR_TYPE_SINGLE:
			return mResources.getDrawable(R.drawable.actionsheet_single);
		case SELECTOR_TYPE_TOP:
			return mResources.getDrawable(R.drawable.actionsheet_top);
		case SELECTOR_TYPE_MIDDLE:
			return mResources.getDrawable(R.drawable.actionsheet_middle);
		case SELECTOR_TYPE_BOTTOM:
			return mResources.getDrawable(R.drawable.actionsheet_bottom);
		default:
			return mResources.getDrawable(R.drawable.actionsheet_top);
		}
	}
	...
	private int getActionButtonColorByType(int type) {
		...
		case DEFAULT_STYLE_BTN:
			return mResources.getColor(R.color.action_sheet_button_blue);
		...
		case GREY_STYLE_BTN:
			return mResources.getColor(R.color.action_sheet_button_blue);
		case RED_STYLE_BTN:
			return mResources.getColor(R.color.action_sheet_button_red);
		case BLUE_STYLE_BTN:
			return mResources.getColor(R.color.action_sheet_button_blue);
		default:
			return mResources.getColor(R.color.action_sheet_button_blue);
	...
	public void setRadioButtonChecked(int index){
		if (index >= 0 && (mContents != null) && (index < mContents.size())) {
			...
			if (mRadioButtonMap != null) {
				...
				if (v != null) {
					v.findViewById(R.id.action_sheet_checkedIcon)
	...
	private void prepareContentViews() {
		...
		if (mMainTitle != null) {
			...
			TextView mainTitleText = (TextView) titleContainer
					.findViewById(R.id.action_sheet_title);
			...
			if (mSecondaryTitle != null) {
				TextView secondaryTitleText = (TextView) titleContainer
						.findViewById(R.id.action_sheet_secondary_title);
		...
		if (mContents != null) {
			...
			for (int i = 0; i < buttonCount; i++) {
				View child = mInflater.inflate(
						R.layout.action_sheet_common_button, null);
				TextView text = (TextView) child
						.findViewById(R.id.action_sheet_button);
				...
				if (mRadioGroupMode) {
					...
					if (i == mCurrentSelectedViewId) {
						child.findViewById(R.id.action_sheet_checkedIcon)
								.setVisibility(View.VISIBLE);
					}
				}
			}
		...
		if (mCancelText != null) {
			View child = mInflater.inflate(R.layout.action_sheet_cancel_button,
					null);
			Button cancelBtn = (Button) child
					.findViewById(R.id.action_sheet_btnCancel);
		...
		public void onClick(View v) {
			...
			if (mRadioGroupMode) {
				if ((mCurrentSelectedViewId != -1)
					...
					oldCheckedBtn.findViewById(R.id.action_sheet_checkedIcon)
							.setVisibility(View.GONE);

					// 显示点击按钮的勾选
					View currentCheckedBtn = mRadioButtonMap.get(id);
					currentCheckedBtn.findViewById(R.id.action_sheet_checkedIcon)
							.setVisibility(View.VISIBLE);
