...
public class Session extends Observable {
	...
	public synchronized static Session getInstance() {
		...
		return FansApplication.getInstance().getSession();
	}
	...
	public Date parse2Date(String time) throws ParseException {
		checkFomatter();
		return formattor.parse(time);
	}
	...
	private void checkFomatter() {
		if (formattor == null)
			try {
				...
				e.printStackTrace();
				formattor = DateFormat.getDateInstance();
			}
	}
